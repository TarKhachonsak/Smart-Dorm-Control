<template>
    <div class="flex justify-between bg-[#FFFFFF] h-[250px] ml-40 mr-40 mt-5 rounded-2xl drop-shadow-[0_35px_35px_rgba(0,0,0,0.10)]">
        <div class="">
            <p class="bg-blue-300 rounded-tl-2xl rounded-br-3xl px-6 text-2xl font-bold">B103</p>
        </div>
        <div class="flex items-center">
            <img src="../public/user.jpg" class="rounded-full h-[150px] w-[150px] border-blue-500 border-8">
         </div>
         <div class="grid grid-cols-2 items-center pl-10">
            <div class="flex items-center">
                <i class="fa-solid fa-user pr-2"></i>
                <p class="pr-3">ชื่อ พลตำรวจเอก ฟามรัก</p>
            </div>
            <div class="flex items-center">
            ...
            <div class="flex items-center">
                ...
                <p>อีเมล pkoekcheiei@gimi.com</p>
            </div>
            <div class="flex items-center">
